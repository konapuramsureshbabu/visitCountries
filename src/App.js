  ...
  render() {
    ...
    return (
      <div className="bg-container">
        <h1 className="heading-class">Countries</h1>
        ...
        <h1 className="heading-class">Visited Countries</h1>
        {filteredCountries.length === 0 ? (
          <div className="no-countries">
            <p className="paragraph-title">No Countries Visited Yet!</p>
          </div>
        ) : (
          <ul className="visited-container">
            {filteredCountries.map(each => (
              <CountriesVisited
                data={each}
                key={each.id}
                onChangeVisited={this.onChangeVisited}
              />
            ))}
          </ul>
        )}
